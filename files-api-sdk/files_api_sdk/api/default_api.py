...
class DefaultApi:
    ...
    @validate_arguments
    def upload_file_v1_files_file_path_put(self, file_path : Annotated[constr(strict=True), Field(..., description="Valid file path without invalid characters")], file : Union[StrictBytes, StrictStr], **kwargs) -> PutFileResponse:  # noqa: E501
    ...
    @validate_arguments
    def upload_file_v1_files_file_path_put_with_http_info(self, file_path : Annotated[constr(strict=True), Field(..., description="Valid file path without invalid characters")], file : Union[StrictBytes, StrictStr], **kwargs) -> ApiResponse:  # noqa: E501
        """Upload File  # noqa: E501
